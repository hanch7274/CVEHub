...
const WebSocketQueryBridge: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // CVE 삭제 이벤트
    const handleCVEDeleted = (data: any) => { // 필요에 따라 data 타입 정의
    ...
    // 구독 상태 변경 이벤트
    const handleSubscriptionUpdated = (data: any) => { // 필요에 따라 data 타입 정의
